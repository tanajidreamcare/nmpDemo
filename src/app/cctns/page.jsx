  ...
  return(
      ...
      <div className="">
        <Navbar/>
          ...
          <h1 className="pt-14 font-headingFont underline" title={t('cctns')}>{t('cctns')}</h1>
        </div>
        <div className="flex items-center justify-center mx-5 my-10 md:mx-44">
          <img src="./navi_head.png" className="w-[100%] h-[50%] rounded-2xl" />
          </div>
          <div className="text[#15233E] bg-lime-200 p-10 rounded-lg text-justify md:mx-20 lg:mx-44 mx-5 ">
